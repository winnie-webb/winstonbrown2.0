...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-900 p-2  fixed top-0 left-0 w-full shadow-md z-50">
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <a href="#hero" className="flex items-center">
              <Image
                ...
                height={60}
              ></Image>
              <h1 className="text-2xl font-bold text-white">Winston Brown</h1>
            </a>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex space-x-4">
              <a
                href="#projects"
                className="text-white hover:text-blue-500 px-3 py-2 rounded-md text-lg font-medium"
              >
                Projects
              </a>
              <a
